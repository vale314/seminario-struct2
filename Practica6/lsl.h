...
//Inserta un dato al incio de la lista
template<typename T>
...
//Ingresa un dato al final de la lista
template<typename T>
...
//Regresa el ultimo dato de la lista
template<typename T>
...
//Insertar un dato en un lugar especifico
template<typename T>
...
//Elimina un nodo por posicion o un dato de la lista por posicion
template<typename T>
...
//Elimina la lista y la inicializa en cero
template<typename T>
void LSL<T>::clear()
{
    if(!empty())
...
//Para acceder a los nodos de manera mas simple, tratando la LSL como un arraglo estatico.
template<typename T>
